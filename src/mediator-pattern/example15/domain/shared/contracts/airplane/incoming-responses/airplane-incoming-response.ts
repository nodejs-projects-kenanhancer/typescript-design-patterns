...
type AirplaneIncomingResponseUnion =
...
export type AirplaneIncomingResponse<
  ...
  TIncomingResponse extends AirplaneIncomingResponseUnion = AirplaneIncomingResponseUnion
> = TIncomingResponse extends { type: TRequestType; success: TSuccess }
  ? TIncomingResponse
  : never;
